# -*- coding: utf-8 -*-
"""
Created on Sun Aug 20 10:34:15 2023
...
df.drop(['General_Health','Exercise', 'Green_Vegetables_Consumption', 'Fruit_Consumption', 'FriedPotato_Consumption'], inplace=True, axis=1)
